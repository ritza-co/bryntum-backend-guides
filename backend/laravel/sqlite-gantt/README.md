# Bryntum Gantt Laravel API

A basic Laravel API for performing CRUD operations on a SQLite database. For use with a Bryntum Gantt front end.
...
This will create a SQLite database file in the project directory with the tasks data.
...
Syncs changes (added, updated, removed) for tasks.
