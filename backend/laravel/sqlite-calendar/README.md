# Bryntum Calendar Laravel API

A basic Laravel API for performing CRUD operations on a SQLite database. For use with a Bryntum Calendar front end.
...
This will create a SQLite database file in the project directory with the events and resources data.
